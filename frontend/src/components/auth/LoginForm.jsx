...
export function LoginForm({ onSubmit, busy, error }) {
  ...
  return (
    ...
    >
      <div className="text-2xl font-semibold tracking-tight text-slate-900">Welcome back</div>
      <div className="mt-2 text-sm text-slate-500">Sign in to keep your notes in motion.</div>
